...
## Code Editor Setup
### VS Code
ESLint - eslint-plugin-react-hooks, eslint-config-react-app
Prettier

## React Concepts

### useState
It is a react hook that allows you to change the value of a variable with a function
...
### useReducer
It is a react hook that will allow you to change the value of a variable with complex logic. The difference between useState and useReducer is that useState is a clear cut way to assign a value to a variable
1. create a function that will receive a value, and the action
...
In this example, you can change the value of enabled to be true or false using the function setEnabled.
